...
class KnowledgeFileModel(Base):
    ...
    # https://zhuanlan.zhihu.com/p/393657724
    # Python 中的每个类都包含 __repr__() 方法，因为 object 类包含 __repr__() 方法，而 Python 中所有的类又都直接或间接继承自 object 类
    # _repr()__是实例对象用来做自我介绍的方法，通过重写该方法，可以自定义它的自我介绍
    def __repr__(self):
